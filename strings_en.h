...
const char HTTP_ROOT_MAIN[]        PROGMEM = "<h2>{t}</h2><h3>{v}</h3>";
//const char HTTP_ROOT_MAIN[]        PROGMEM = "<h1 style='background-color:DodgerBlue;'>{t}</h1><h3>{v}</h3>";

const char * const HTTP_PORTAL_MENU[] PROGMEM = {
"<form action='/wifi'    method='get'><button>Cập nhật WiFi Mới</button></form><br/>\n", // MENU_WIFI
"<form action='/0wifi'   method='get'><button>Configure WiFi (No Scan)</button></form><br/>\n", //MENU_SEP
"<form action='/info'    method='get'><button>Thông tin Phần cứng</button></form><br/>\n", // MENU_INFO
"<form action='/param'   method='get'><button>Thiết lập</button></form><br/>\n", //MENU_PARAM
"<form action='/close'   method='get'><button>Đóng</button></form><br/>\n", // MENU_CLOSE
"<form action='/restart' method='get'><button>làm mới</button></form><br/>\n", // MENU_RESTART
"<form action='/exit'    method='get'><button>Thoát</button></form><br/>\n", // MENU_EXIT
"<form action='/erase'   method='get'><button class='D'>Erase</button></form><br/>\n", // MENU_ERASE
"<form action='/update'  method='get'><button>Cập Nhật Phần mềm(Admin)</button></form><br/>\n",// MENU_UPDATE
"<hr><br/>" // MENU_SEP
};
...
const char HTTP_FORM_WIFI[]        PROGMEM = "<label for='s'>Tên WiFi</label><input id='s' name='s' maxlength='32' autocorrect='off' autocapitalize='none' placeholder='{v}'><br/><label for='p'>Mật Khẩu WiFi</label><input id='p' name='p' maxlength='64' type='password' placeholder='{p}'>";
const char HTTP_FORM_WIFI_END[]    PROGMEM = "";
const char HTTP_FORM_STATIC_HEAD[] PROGMEM = "<hr><br/>";
const char HTTP_FORM_END[]         PROGMEM = "<br/><br/><button type='submit'>Cập Nhật</button></form>";
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Đang Cập Nhật Dữ Liệu.<br/> .....Đang trong quá trình kết nối.....<br />Vui lòng không thoát ra ngoài !! </div>";
...
const char HTTP_BACKBTN[]          PROGMEM = "<hr><br/><form action='/' method='get'><button>Trở ra</button></form>";

const char HTTP_STATUS_ON[]        PROGMEM = "<div class='msg S'><strong>Đã kết nối</strong> to {v}<br/><em><small>with IP {i}</small></em></div>";
const char HTTP_STATUS_OFF[]       PROGMEM = "<div class='msg {c}'><strong>Không kết nối được</strong> với {v}{r}</div>"; // {c=class} {v=ssid} {r=status_off}
const char HTTP_STATUS_OFFPW[]     PROGMEM = "<br/>Authentication Failure"; // STATION_WRONG_PASSWORD,  no eps32
const char HTTP_STATUS_OFFNOAP[]   PROGMEM = "<br/>Không tìm thấy WiFi đã lưu";   // WL_NO_SSID_AVAIL
const char HTTP_STATUS_OFFFAIL[]   PROGMEM = "<br/>Kết nối không thành công"; // WL_CONNECT_FAILED
...
"button,input[type='button'],input[type='submit']{cursor:pointer;border:0;background-color:#008090;color:#000000;line-height:2.4rem;font-size:1.2rem;width:100%}"
"input[type='file']{border:1px solid #1fa3ee}"
".wrap {text-align:left;display:inline-block;min-width:260px;max-width:500px}"
// links
"a{color:#000;font-weight:700;text-decoration:none}a:hover{color:#1fa3ee;text-decoration:underline}" //màu tên wifi
// quality icons
...
const char HTTP_HELP[]             PROGMEM =
 "<br/><h3>Thông tin</h3><hr>"
 "<table class='table'>"
 "<tr><td><a href='/Authur'>/</a></td>"
 "<td>Thông tin tác giả</td></tr>"
 "<tr><td><a href='/wifi'>/Khoa Điện Điện Tử Viễn Thông</a></td>"
 "<td>Trường ĐH Kỹ Thuật Công Nghệ Cần Thơ</td></tr>"
 "<tr><td><a href='/wifisave'>Họ Và Tên Sinh Viên</a></td>"
 "<td>Ngô Việt Tứ MSSV 1800188 Điện 0218.</td></tr>"
 "<tr><td><a href='/wifisave'>Giảng Viên Hướng Dẫn</a></td>"
 "<td>Ks. Diệp Long </td></tr>"
 "<tr><td><a href='/param'>/Luận Văn Tốt Nghiệp</a></td>"
 "<td>Đề tài Quản Lý Và Giám Sát Điện Năng Dùng Arduino Ứng Dụng Công Nghệ IoT</td></tr>"
 "<tr><td><a href='/info'>/Thông tin truy cập</a></td>"
 "<td>https://khoaddtvt.ctuet.edu.vn</td></tr>"
 "</table>"
 "<p/>Để xem nhiều thông tin hơn xin mời bạn truy cập <a href='https://khoaddtvt.ctuet.edu.vn/'>https://khoaddtvt.ctuet.edu.vn</a>.";
#else
const char HTTP_HELP[]             PROGMEM = "";
#endif
...
#else
	const char HTTP_INFO_esphead[]    PROGMEM = "<h3>Vi Điều Khiển</h3><hr><dl>";
	const char HTTP_INFO_fchipid[]    PROGMEM = "<dt>Số hiệu Flash Chip ID</dt><dd>{1}</dd>";
...
const char S_brand[]              PROGMEM = "ĐẠI HỌC KỸ THUẬT - CÔNG NGHỆ CẦN THƠ";
